        ...
        <div class="max-width">
            ...
            <div class="content-main">
                <div class="contact-article row">
                    <div class="contact-text col-6">{!! Func::decodeHtmlChars($contact['contentvi']??'') !!}</div>
                    <form class="contact-form validation-contact col-6" novalidate method="post"
                        action="{{ url('lien-he-post') }}" enctype="multipart/form-data">
                        <div class="row-20 row">
                            <div class="contact-input col-6 col-20 mb-3">
